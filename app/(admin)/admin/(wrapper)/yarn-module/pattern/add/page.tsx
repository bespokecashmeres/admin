...
import { PATTERN_ADD_URL, PATTERN_UPDATE_URL } from "@/constants/apis";
import {
  ...
  return (
    <AddEditWrapper title={t("COMMON.CREATE")}>
      <YarnModuleFormComponent
        addApi={PATTERN_ADD_URL}
        redirectUrl={FULL_PATH_ROUTES.adminYarnModulePattern}
        updateApi={PATTERN_UPDATE_URL}
      />
    </AddEditWrapper>
  );
};
