...
const DropdownField: React.FC<DropdownFieldProps> = ({
  ...
  error = "",
  disabled = false,
  onChange, // Accept an optional onChange handler
  value, // Controlled value passed from react-hook-form
}) => {
    ...
    <div className="w-full mb-4">
      ...
      <Select
        ...
        classNames={{
          ...
          control: () =>
            clsx(
              "font-white border-stroke pr-1 py-0.5 dark:border-gray-600 dark:bg-gray-800 outline-none",
              error
